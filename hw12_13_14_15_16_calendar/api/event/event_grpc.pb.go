...
//
// EventService provides calendar event management API.
...
func (c *eventServiceClient) ListDay(ctx context.Context, in *ListDayRequest, opts ...grpc.CallOption) (*ListEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *eventServiceClient) ListWeek(ctx context.Context, in *ListWeekRequest, opts ...grpc.CallOption) (*ListEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListEventsResponse)
...
func (c *eventServiceClient) ListMonth(ctx context.Context, in *ListMonthRequest, opts ...grpc.CallOption) (*ListEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListEventsResponse)
...
func (UnimplementedEventServiceServer) ListDay(context.Context, *ListDayRequest) (*ListEventsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListDay not implemented")
}
func (UnimplementedEventServiceServer) ListWeek(context.Context, *ListWeekRequest) (*ListEventsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListWeek not implemented")
}
func (UnimplementedEventServiceServer) ListMonth(context.Context, *ListMonthRequest) (*ListEventsResponse, error) {
